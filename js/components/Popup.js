class Popup {
  ...
  generatePopupData = (
    ...
    firstButton.addEventListener('click', () => (firstButton ? window.open(liveVersion, '_blank') : ''));

    secondButton.addEventListener('click', () => (secondButton ? window.open(sourceCode, '_blank') : ''));
